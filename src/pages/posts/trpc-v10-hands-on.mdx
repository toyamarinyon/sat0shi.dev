...
![StackBlitz loading page](/assets/posts/trpc@10-hands-on/stackblitz-init.jpeg)

After about 20 seconds, you'll see the page change like this. This is the starter template page.

![running local server on StackBlitz](/assets/posts/trpc@10-hands-on/running-dev-server-on-stackblitz.jpeg)
...
<Callout label="note">
  ...
  ![useQuery](/assets/posts/trpc@10-hands-on/suggest-filter.gif)
...
Then, you can create a post with tRPC!
  ...
  ![useQuery](/assets/posts/trpc@10-hands-on/mutation-demo.gif)
